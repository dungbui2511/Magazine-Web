            ...
            <div class="container-fluid py-6 col-lg-12" style="margin-top:60px;">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input value="{{$row->name}}" type="text" class="form-control" placeholder="username"
                            name="username" autofocus><br>
                    </div>
                    <div class="mb-3">
                        <label for="file" class="form-label">Email</label><br>
                        <input value="{{$row->email}}" type="text" class="form-control" placeholder="email"
